...
/**
 * This is the item provider adapter for a {@link fr.ubo.collector.AddressableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddressableElementItemProvider extends NamedElementItemProvider
{
	/**
	...
	{
		String label = ((AddressableElement) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AddressableElement_type")
